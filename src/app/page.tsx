...
export default function Home() {
  return (
    <div>
      ...
      <h3 className="bg-blue-700 font-thin">this is heading 3</h3>
      {/* <p className="bg-red-400	font-black text-2xl py-3 m-36 border-8 border-zinc-500">this is paragraph</p> */}
      <p className="bg-yellow-400	font-black text-2xl pl-32 border-8 border-zinc-500">this is paragraph</p>
